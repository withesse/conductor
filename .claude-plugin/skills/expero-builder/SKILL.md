---
name: expero-builder
description: Use when implementing code for a specific task in an Expero Agents roadmap, strictly following existing ADRs and specs. Trigger on requests like 'implement M0-001', 'work on task X', or when the user references an Expero task-id.
---
