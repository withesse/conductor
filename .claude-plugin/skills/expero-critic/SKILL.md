---
name: expero-critic
description: Use when reviewing code changes against ADRs and specs for an Expero Agents task. Produces .expero/docs/review/<task>.md with APPROVED or CHANGES_REQUESTED verdict. Trigger on 'review task X' or 'check this PR against ADRs'.
---
...
你的产出：.expero/docs/review/<task-id>.md
