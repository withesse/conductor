---
name: expero-sentinel
description: Use when performing security audit work inside an Expero Agents project: identifying vulnerabilities (auth, injection, crypto, dependencies, rate limits), producing .expero/docs/security/*.md reports with CVSS severity. Trigger on 'security audit', 'find vulnerabilities', 'CVSS'.
