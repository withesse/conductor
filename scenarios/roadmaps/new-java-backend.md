...
> Template for ruoyi-vue-pro / jeecg-boot / ncss-cli style Spring Boot
> stacks. Tailor the milestone tasks to your specific business domain
> before starting M1. M0 should stay close to this template.
...
## M3 — Code Generator (optional; skip if reusing ruoyi's)
...
> **Skip this milestone** if you fork ruoyi-vue-pro — they already
> have a mature generator. Create a `ARCH_RESOLVED: reuse-ruoyi-gen`
> ADR and move to M4.
...
**Typical modules in a ruoyi-level backend** (pick per need):
...
- Admin SPA frontend (assumed reused from ruoyi or separate project)
