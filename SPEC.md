...
| Role | Claude Code 推荐 | Codex / GPT 推荐 | Gemini 推荐 |
|------|-----------------|------------------|-------------|
| Architect | Opus | o3 | Gemini 2.5 Pro |
| Planner | Sonnet | o4-mini | Gemini 2.5 Flash |
| Builder | Sonnet | o3 (Rust) / o4-mini (其他) | Gemini 2.5 Pro |
| Verifier | Haiku | o4-mini | Gemini 2.5 Flash |
| Critic | Sonnet | o3 | Gemini 2.5 Pro |
| Sentinel | Opus | o3 | Gemini 2.5 Pro |
| Scribe | Sonnet | o4-mini | Gemini 2.5 Flash |
| Archaeologist | Opus | o3 | Gemini 2.5 Pro |

### 7.2 工具混用原则

混用是推荐实践，不是妥协。不同工具有不同优势：

- Claude Opus：长文档推理、架构决策质量最高
- Codex o3：Rust / 复杂类型系统代码生成最强
- Gemini 2.5 Pro：大上下文窗口场景（> 500K token）
